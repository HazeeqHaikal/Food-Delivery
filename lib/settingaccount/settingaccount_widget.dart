...
export 'settingaccount_model.dart';

class SettingaccountWidget extends StatefulWidget {
  const SettingaccountWidget({Key? key}) : super(key: key);

  @override
  _SettingaccountWidgetState createState() => _SettingaccountWidgetState();
}

class _SettingaccountWidgetState extends State<SettingaccountWidget>
    with TickerProviderStateMixin {
  late SettingaccountModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SettingaccountModel());
                          ...
                          child: Row(
                            ...
                            children: [
                              ClipRRect(
                                ...
                                child: Image.asset(
                                  'assets/images/macos-sierra-night-shift-icon-black.png',
                                  width: 27.0,
                                  height: 27.0,
                                  fit: BoxFit.fill,
                                ),
